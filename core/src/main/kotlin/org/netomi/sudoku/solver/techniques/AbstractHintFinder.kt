...
abstract class AbstractHintFinder : HintFinder
{
    /**
     * Adds a direct placement hint to the `HintAggregator`.
     */
    protected fun placeValueInCell(grid:           Grid,
     ...
     */
    protected fun eliminateValueFromCells(grid:           Grid,
                                          hintAggregator: HintAggregator,
                                          affectedHouse:  House,
                                          excludedHouse:  House,
                                          excludedValue:  Int)
     ...
     */
    protected fun eliminateNotAllowedValuesFromCells(grid:           Grid,
                                                     hintAggregator: HintAggregator,
     ...
     */
    protected fun eliminateValuesFromCells(grid:           Grid,
                                           hintAggregator: HintAggregator,
                                           affectedCells:  CellSet,
