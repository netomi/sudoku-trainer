    ...
    : TechniqueCategoryOrLibraryEntry
{
    ...
    FinnedFish          ("Finned Fish", "031x", All),
    FinnedXWing         ("Finned X-Wing", "0310", FinnedFish),
    FinnedSwordfish     ("Finned Swordfish", "0311", FinnedFish),
    FinnedJellyfish     ("Finned Jellyfish", "0312", FinnedFish),
    ...
    UniqueRectangleType4("Unique Rectangle Type 4", "0603", Uniqueness),
    Wings               ("Wings", "08xx", All),
    XYWing              ("XY-Wing", "0800", Wings),
    XYZWing             ("XYZ-Wing", "0801", Wings),
    WWing               ("W-Wing", "0803", Wings),
